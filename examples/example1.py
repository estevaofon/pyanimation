...
goku = Animation(initial_action="down")
sprite = "images/goku-ss4.png"
goku.load_sprites(sprite)

# automatic creatin stand by position
goku.create_animation(0, 0, 48, 70, 4, "down", hold=False)
...
goku.build_animation("kick", hold=True, speed=5)
...
goku.build_animation("combo", hold=True, speed=5)

# loading
goku.insert_frame(115, 1400, 83, 90)
goku.insert_frame(195, 1400, 83, 90)
goku.build_animation("load", hold=True, speed=15)
